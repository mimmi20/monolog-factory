...
final class ElasticsearchHandlerFactory2Test extends TestCase
{
    ...
    public function testInvokeWithConfigWithArrayConfigForV7ClientButLoaderError2(): void
    {
        ...
        $monologClientPluginManager = $this->createMock(AbstractPluginManager::class);
        ...
        $elasticsearchHandlerFactory($container, '', ['client' => $clientConfig]);
    }
    ...
    public function testInvokeWithConfigWithArrayConfigForV7ClientButLoaderError3(): void
    {
        ...
        $elasticsearchHandler = $elasticsearchHandlerFactory($container, '', ['client' => $clientConfig]);
    ...
    public function testInvokeV8ClientAndWithConfigAndFormatter(): void
    {
        ...
        $container->expects($invokedCount)
            ->method('get')
            ->willReturnCallback(
                static function (string $id) use ($invokedCount, $client, $clientClass): V8Client {
