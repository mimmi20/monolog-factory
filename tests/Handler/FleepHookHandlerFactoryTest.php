...
final class FleepHookHandlerFactoryTest extends TestCase
{
    ...
    public function testInvokeWithConfigAndFormatter4(): void
    {
        ...
        $factory($container, '', ['token' => $token, 'level' => $level, 'bubble' => $bubble, 'timeout' => $timeout, 'writingTimeout' => $writeTimeout, 'connectionTimeout' => $connectionTimeout, 'persistent' => $persistent, 'chunkSize' => $chunkSize, 'formatter' => $formatter]);
    }
    ...
    public function testInvokeWithConfigAndProcessors3(): void
    {
        ...
        $handler = $factory($container, '', ['token' => $token, 'level' => $level, 'bubble' => $bubble, 'timeout' => $timeout, 'writeTimeout' => $writeTimeout, 'persistent' => $persistent, 'chunkSize' => $chunkSize, 'processors' => $processors]);
